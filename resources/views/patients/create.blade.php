    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Novo Cadastro</span>
                </div>
            </li>
        </ol>
    </nav>
...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-2xl p-6">
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Cadastrar Novo Paciente</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Preencha as informações abaixo para registrar o paciente.</p>
            </div>
            ...
            <form action="{{ route('patients.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="document_cpf" name="document_cpf" type="text" class="mt-1 block w-full" :value="old('document_cpf')" placeholder="000.000.000-00" data-mask="cpf" />
                    ...
                    <div>
                        ...
                        <x-text-input id="phone" name="phone" type="text" class="mt-1 block w-full" :value="old('phone')" placeholder="+55 (00) 00000-0000" data-mask="phone" />
                    ...
                    <div>
                        ...
                        <x-text-input id="emergency_contact_phone" name="emergency_contact_phone" type="text" class="mt-1 block w-full" :value="old('emergency_contact_phone')" placeholder="+55 (00) 00000-0000" data-mask="phone" />
                ...
                <div class="flex items-center justify-end mt-8 gap-4">
                    <a href="{{ route('patients.index') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 underline">
                        Cancelar
                    </a>
