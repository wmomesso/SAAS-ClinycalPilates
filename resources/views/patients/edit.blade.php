                ...
                <div class="border-t border-gray-100 dark:border-gray-700 pt-6">
                    ...
                    <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea id="allergies" name="allergies" rows="3" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-primary-500 dark:focus:border-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 rounded-xl shadow-sm">{{ old('allergies', $patient->allergies) }}</textarea>
                            <x-input-error class="mt-2" :messages="$errors->get('allergies')" />
                        </div>

                        <div>
                            <x-input-label for="medications" :value="__('Medicamentos em Uso')" />
                            <textarea id="medications" name="medications" rows="3" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-primary-500 dark:focus:border-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 rounded-xl shadow-sm">{{ old('medications', $patient->medications) }}</textarea>
                            <x-input-error class="mt-2" :messages="$errors->get('medications')" />
                        </div>

                        <div>
                            <x-input-label for="lifestyle_habits" :value="__('Hábitos de Vida')" />
                            <textarea id="lifestyle_habits" name="lifestyle_habits" rows="3" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-primary-500 dark:focus:border-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 rounded-xl shadow-sm">{{ old('lifestyle_habits', $patient->lifestyle_habits) }}</textarea>
