...
@section('content')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('payables.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-primary-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Financeiro</a>
                </div>
            </li>
    ...
    <div class="p-4 bg-white dark:bg-gray-800 flex justify-between items-center rounded-t-lg">
        ...
        <div>
            <a href="{{ route('payables.create') }}" class="inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-center text-white bg-primary-600 rounded-xl hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 dark:bg-primary-500 dark:hover:bg-primary-600 focus:outline-none dark:focus:ring-primary-800">
            ...
            @foreach($payables as $payable)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">
                        @php
                            $statusColors = [
                                ...
                                'partially_paid' => 'bg-primary-100 text-primary-800 dark:bg-primary-900 dark:text-primary-200',
                    ...
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('payables.edit', $payable) }}" class="font-medium text-primary-600 dark:text-primary-400 hover:underline">Editar</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
