...
@section('content')
    ...
    <div class="p-4 bg-white dark:bg-gray-800 flex justify-between items-center rounded-t-lg">
        ...
        <div>
            <a href="{{ route('clinic-users.create') }}" class="inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-center text-white bg-primary-600 rounded-xl hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 dark:bg-primary-500 dark:hover:bg-primary-600 focus:outline-none dark:focus:ring-primary-800">
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    @foreach($user->roles as $role)
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-primary-100 text-primary-800 dark:bg-primary-900 dark:text-primary-200 mr-1">
                            {{ $role->name }}
                        </span>
                    @endforeach
                </td>
                ...
                <td class="px-6 py-4 text-right">
                    <a href="{{ route('clinic-users.edit', $user->id) }}" class="font-medium text-primary-600 dark:text-primary-400 hover:underline">Editar</a>
                    <a href="{{ route('clinic-users.show', $user->id) }}" class="font-medium text-primary-600 dark:text-primary-400 hover:underline">Visualizar</a>
                </td>
            </tr>
            @endforeach
            </tbody>
