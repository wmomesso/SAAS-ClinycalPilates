<x-guest-layout>
    <div class="text-center mb-6">
        <h2 class="text-xl font-bold text-gray-800 dark:text-white">Bem-vindo de volta</h2>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Faça login para acessar sua conta</p>
    </div>
        ...
        <div class="flex items-center justify-between">
            <label for="remember_me" class="inline-flex items-center cursor-pointer">
                <input id="remember_me" type="checkbox"
                       class="rounded border-gray-300 dark:border-gray-600 text-primary shadow-sm focus:ring-primary dark:focus:ring-primary dark:focus:ring-offset-gray-800 w-3.5 h-3.5"
                       name="remember">
                <span class="ml-2 text-xs text-gray-600 dark:text-gray-400">{{ __('Lembrar-me') }}</span>
            </label>
