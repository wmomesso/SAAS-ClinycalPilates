<x-guest-layout>
    <div class="text-center mb-6">
        <h2 class="text-xl font-bold text-gray-800 dark:text-white">Redefinir Senha</h2>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Digite sua nova senha</p>
    </div>
